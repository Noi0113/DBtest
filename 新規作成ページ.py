...
new_kazu = st.text_input("試合数を入力してください（これは今どこにも保存されてないと思う）")
new_shozoku = st.text_input("参加大学数を入力してください")
new_shozokuname = st.text_input("参加大学名１を入力してください（これを大学数分繰り返しできるようにしたい）")
